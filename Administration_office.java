...
public class Administration_office extends JFrame implements Observer, ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==btn1) {			//Add permit
                        ...
                        if(txtName.getText() == "" || txtReg.getText() == "" || txtMake.getText() == "" || 
                                                      txtModel.getText() == "" || txtColour.getText() == "" || 
                                                      (String) bxType.getSelectedItem() == "" || txtDate.getText() == "")
                        {
                            
                            System.out.println("Ensure all fields are filled in");
                        }
                        else if(txtName.getText() == "" || txtReg.getText() == "" || txtMake.getText() == "" || 
                                                      txtModel.getText() == "" || txtColour.getText() == "" || 
                                                      txtDate.getText() == "" ||  (String) bxType.getSelectedItem() == "Day Visitor" ||  
                                                      (String) bxType.getSelectedItem() == "Regular Visitor" && txtHost.getText() == "")
                        {
                           System.out.println("Ensure all fields are filled in"); 
                        }
                        else
			...
			if(txtReg2.getText() == "")
                        {
                            System.out.println("Ensure the relevant fields have been filled in");
                        }
                        else
                        {
			...
			if(txtReg4.getText() == "")
                ...
                {	//Status Enquiry - A member of the administration is able to obtain status details for a given user: details of permit, whether warnings are recorded, whether suspended, and how many entries to campus have occurred since the permit was issued.
			System.out.println("btn5");

		}else if (e.getSource()==btn6) 
                {	//Modify Permit - Change details in the permit, maybe enter name or reg and click get which will display the details in the boxes, and change boxes to modify it (dont modify reg or user ID)
